...
$cookieFile = sys_get_temp_dir() . '/wpe_cookie_' . uniqid() . '.txt';
$curlTimeout = 60;
...
log_msg("Login sukses! Cookie: $cookieFile");
...
// cursor_page mapping versi compat
$cursorMap = array(
    1  => 62,
    2  => 64,
    3  => 65,
...
for ($page = $pageStart; $page <= $pageEnd; $page++) {
    $cursorPage = isset($cursorMap[$page]) ? $cursorMap[$page] : 1;
    $url = $apiBase . "/gateway/apiHeartbeatEDC/1.0/tid?period=gte7d&list=list_region&merchant_type=RITEL&code=region_code&value=X&page=$page&limit=1000&offset_trx_time=2025-10-03%2015:24:30&offset_id=0&cursor_page=$cursorPage&cache_key=black&count_last_record=0&date=2025-10-03&is_domicile=false&is_new_merchant=false";
    ...
    $items = isset($j['data']['data']) ? $j['data']['data'] : array();
