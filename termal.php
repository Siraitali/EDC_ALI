...
<body>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu flex-column" id="merchantMenu">
                    ...
                    <li><a href="#" class="nav-link">Group Uker</a></li>
                    <li><a href="#" class="nav-link">Group Vendor</a></li>
                    <li><a href="#" class="nav-link">Time Series</a></li>
                </ul>
            </li>
            ...
            <li class="nav-item stok mt-3">
                ...
                <ul class="submenu flex-column show" id="stokMenu">
                    ...
                    <li><a href="termal.php" class="nav-link active">Termal</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <!-- Konten Termal -->
    <div class="content">
        <h2>Halaman Termal</h2>
        <p>Konten masih kosong bro.</p>
    </div>
