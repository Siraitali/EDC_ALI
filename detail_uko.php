...
// Query data detail
$sql = "SELECT * FROM detail_uko WHERE mid = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Detail MID <?= htmlspecialchars($mid) ?></title>
            ...
            <?php if ($data): ?>
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        Detail TID: <?= htmlspecialchars($data['mid']) ?>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3"><strong>MID:</strong> <?= htmlspecialchars($data['tid']) ?></div>
                            <div class="col-md-6 mb-3"><strong>Nama Merchant:</strong> <?= htmlspecialchars($data['nama_merchant']) ?></div>
                            <div class="col-md-6 mb-3"><strong>Kantor Cabang:</strong> <?= htmlspecialchars($data['kantor_cabang']) ?></div>
                            <div class="col-md-6 mb-3"><strong>Posisi EDC:</strong> <?= htmlspecialchars($data['posisi_edc']) ?></div>
                            <div class="col-md-6 mb-3"><strong>Nama Instansi Kerjasama:</strong> <?= htmlspecialchars($data['nama_instansi']) ?></div>
                            <div class="col-md-6 mb-3"><strong>Merek Mesin:</strong> <?= htmlspecialchars($data['merk_mesin']) ?></div>
                            <div class="col-md-6 mb-3"><strong>SN Mesin:</strong> <?= htmlspecialchars($data['sn_mesin']) ?></div>
                             <div class="col-md-6 mb-3"><strong>Kondisi Perangkat :</strong> <?= htmlspecialchars($data['kondisi_perangkat']) ?></div>
                             <div class="col-md-12 mb-3"><strong>Keterangan:</strong> <?= htmlspecialchars($data['keterangan']) ?></div>
                            <div class="col-md-6 mb-3"><strong>Status Perangkat:</strong> <?= htmlspecialchars($data['status_isi_merk']) ?></div>
                    </div>
                </div>
            <?php else: ?>
                <div class="alert alert-danger">Data dengan TID <?= htmlspecialchars($mid) ?> tidak ditemukan.</div>
            <?php endif; ?>
        </div>
    </div>
